...
public class CopyFile {
    ...
    public static void main(String[] args) {
        ...
        copyFile("data.txt", "output.txt", true);
    ...
    public static int copyFile(String sourceName, String copyName, boolean force) {
        ...
        try (BufferedReader source2 = new BufferedReader(new FileReader(new File(sourceName)))) {
            while (source2.ready()) { // Anything to read in the Stream? -- Data to read from target file?
                lines.add(source2.readLine()); // Write content from file to array
            }
        } catch (IOException e) {
